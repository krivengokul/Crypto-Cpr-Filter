...
export const patterns: Pattern[] = [
  ...
  { id: "HB-L1<PL1-PU12CU23", label: "L1<PL1-HB-PU12CU23",  subtitle: "Bullish Target:2PU4",       icon: TrendingUp },
  { id: "HB-L1<PL4-U1>TCPR",  label: "L1<PL4, U1>TCPR",     subtitle: "Bullish Target:2U4",       icon: TrendingUp },
  { id: "HB-L1<PL2-U12CPU12", label: "HB-L1<PL2-U12CPU12",   subtitle: "Bearish Target:L4",       icon: TrendingDown },
  { id: "HB-L1>PL1-PU1CU234", label: "HB-L1>PL1-PU1CU234",   subtitle: "Bearish Target:L4",       icon: TrendingDown }
];
